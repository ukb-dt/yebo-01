...
<div style="display: flex; justify-content: center; gap: 20px; margin: 20px 0;">
  ...
  <img src="https://theaisummer.com/static/1309e29d94e64f58f352ba7051b27acc/ee604/optimization.png" 
       alt="SGD descent paths comparison" 
       style="max-width: 48%; height: auto; border-radius: 8px; box-shadow: 0 4px 16px rgba(0,0,0,0.15);">
  
  <!-- Right: momentum/Adam variants animating the same surface -->
  <img src="https://editor.analyticsvidhya.com/uploads/121381obtV.gif" 
       alt="Different optimizers navigating loss landscape" 
       style="max-width: 48%; height: auto; border-radius: 8px; box-shadow: 0 4px 16px rgba(0,0,0,0.15);">
</div>

<div style="display: flex; justify-content: center; gap: 20px; margin: 20px 0;">
  <!-- Left: classic SGD + momentum descent trails -->
  <img src="landscape/ecosystem-1.jpg" 
       alt="SGD descent paths comparison" 
       style="max-width: 48%; height: auto; border-radius: 8px; box-shadow: 0 4px 16px rgba(0,0,0,0.15);">
  
  <!-- Right: momentum/Adam variants animating the same surface -->
  <img src="landscape/ecosystem-2.gif" 
       alt="Different optimizers navigating loss landscape" 
       style="max-width: 48%; height: auto; border-radius: 8px; box-shadow: 0 4px 16px rgba(0,0,0,0.15);">
</div>
...
<div style="text-align: center; margin: 30px 0;">
  <img src="https://thumbs.dreamstime.com/b/d-diorama-river-landscape-cross-section-detailed-illustrates-dynamic-flow-carving-its-path-lush-green-view-415429587.jpg" 
